  ...
  window.PRODUCTS = [
    {
      ...
      visible: true,
      title: "Product One",
      shortDescription: "A limited object made individually, with small variations that record the hand of its maker.",
      fullDescription: "Product One is an original object produced in a limited quantity. Each piece is finished individually, so subtle differences in surface and form are part of the work.",
      price: "",
